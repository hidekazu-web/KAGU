    ...
    <section class="p-section">
      <div class="l-container l-container--narrow p-section__content">
        <div class="p-col p-col--col4">
          <a href="<?php echo get_post_type_archive_link('post'); ?>" class="p-col__item c-btn c-btn--archive">すべて</a><!-- /.p-col__item c-btn -->
          <?php $terms = get_terms('category', array(
            'hide_empty' => false,
          ));
          if ($terms) : ?>
            <?php foreach ($terms as $term) : ?>
              <a href="<?php echo esc_html(get_term_link($term, 'category')); ?>" class="p-col__item c-btn c-btn--archive <?php if(get_the_archive_title() == $term->name) { echo 'isActive'; }; ?>"><?php echo esc_html($term->name); ?></a><!-- /.p-col__item c-btn -->
            <?php endforeach; ?>
          <?php endif; ?>
