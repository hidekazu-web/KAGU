    ...
    <section class="p-section">
      <div class="l-container l-container--narrow p-section__content">
        ...
        <div class="p-col p-col--col4">
          ...
          <?php $terms = get_terms($queried_object->taxonomy, array(
            'hide_empty' => false,
          ));
          if ($terms) : ?>
            <?php foreach ($terms as $term) : ?>
              <a href="<?php echo esc_html(get_term_link($term, $queried_object->taxonomies[0])); ?>" class="p-col__item c-btn c-btn--archive <?php if($queried_object->slug == $term->slug) { echo 'isActive'; }; ?>"><?php echo esc_html($term->name); ?></a><!-- /.p-col__item c-btn -->
            <?php endforeach; ?>
          <?php endif; ?>
